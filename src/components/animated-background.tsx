...
export function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    const gradients = [
      { x: 0.2, y: 0.3, color1: 'rgba(100, 70, 255, 0.15)', color2: 'rgba(100, 70, 255, 0)' },
      { x: 0.8, y: 0.4, color1: 'rgba(200, 100, 255, 0.12)', color2: 'rgba(200, 100, 255, 0)' },
      { x: 0.5, y: 0.7, color1: 'rgba(120, 180, 255, 0.1)', color2: 'rgba(120, 180, 255, 0)' },
      { x: 0.6, y: 0.2, color1: 'rgba(150, 120, 255, 0.11)', color2: 'rgba(150, 120, 255, 0)' },
      { x: 0.3, y: 0.8, color1: 'rgba(180, 100, 255, 0.09)', color2: 'rgba(180, 100, 255, 0)' }
    ]
